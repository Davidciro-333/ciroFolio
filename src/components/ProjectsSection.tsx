        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard className="group overflow-hidden dark:border-primary/10 h-full flex flex-col">
                <CardHeader className="bg-gradient-to-r from-primary/5 to-amber-400/5">
                ...
                <CardFooter className="flex justify-center md:justify-start items-center border-t border-border/30 bg-gradient-to-r from-primary/5 to-amber-400/5">
                  <motion.a
                    href={project.github}
                    target="_blank"
